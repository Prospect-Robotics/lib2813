 ...
 *
 * <p>This subsystem uses a {@link PIDMotor} and allows controlling the motor in intake and
 * outtake directions with preconfigured demand values. Commands are provided for common actions
 * such as intaking, outtaking, and stopping the motor.
 */
