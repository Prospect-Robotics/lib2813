 ...
 *
 * <p>Provides methods to convert boxed {@link Optional} types to their corresponding primitive
 * {@code Optional} types. This class is non-instantiable.
 */
final class Optionals {

  /**
   * Private constructor to prevent instantiation. Invoking this constructor will always throw an
   * {@link AssertionError}.
   */
  private Optionals() {
   ...
   * @return an {@code OptionalLong} containing the value if present, or an empty {@code
   *     OptionalLong} if not
   */
   ...
   * @return an {@code OptionalDouble} containing the value if present, or an empty {@code
   *     OptionalDouble} if not
   */
